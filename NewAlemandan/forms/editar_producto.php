...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conexion->prepare("UPDATE productos SET nombre = ?, categoria = ?, stock = ?, precio = ?, ultima_actualizacion = ? WHERE id = ?");
    $stmt->execute([$nombre, $categoria, $stock, $precio, $fecha, $id]);
